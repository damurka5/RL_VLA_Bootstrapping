...
class CDPREnvHoldStepTests(unittest.TestCase):
    def test_apply_action_holds_same_command_for_all_substeps(self):
        ...
        env._apply_action(np.array([1.0, -1.0, 0.5, 1.0, -1.0], dtype=np.float32))
        ...
        self.assertAlmostEqual(sim.gripper, 0.45, places=6)
        ...
        for target_xyz, yaw, gripper in sim.step_commands:
            ...
            self.assertAlmostEqual(gripper, 0.45, places=6)
