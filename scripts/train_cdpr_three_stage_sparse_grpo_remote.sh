...
WARMSTART_CHECKPOINT="${WARMSTART_CHECKPOINT:-$REPO_ROOT/runs/release_recovery_continue_3m_20260908_102004/rl/step_2117145/smolvla_grpo_adapter.pt}"
MAX_TRAIN_STEPS="${MAX_TRAIN_STEPS:-3000000}"
...
if not bool(getattr(args, "train_vla_lora", False)):
    failures.append("train_vla_lora is off; the selected SFT checkpoint carries LoRA")
...
printf 'selection metric: validation strict placement; plate/bowl separately\n'
