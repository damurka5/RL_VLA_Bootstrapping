...
RUN_NAME="$(cdpr_compose_run_name "cdpr_smolvla_move_to_scratch_mjwarp_w${WORLDS_PER_RANK}")"
...
if [[ "$MAX_TRAIN_STEPS" -ne 16000000 ]]; then
  echo "This scratch launcher requires MAX_TRAIN_STEPS=16000000." >&2
  exit 2
fi
